...
const Header: React.FC<Props> = ({ variant = 'default' }) => {
  ...
  return (
    ...
    >
      <div className="innerSticky text-gray-700 body-font fixed bg-[#F05840] w-full h-16 sm:h-20 lg:h-24 z-20 ltr:pl-4 ltr:lg:pl-6 ltr:pr-4 ltr:lg:pr-6 rtl:pr-4 rtl:lg:pr-6 rtl:pl-4 rtl:lg:pl-6 transition duration-200 ease-in-out">
