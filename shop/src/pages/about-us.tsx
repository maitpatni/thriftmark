    ...
    return (
        <>
            <img className="w-full" src="/assets/images/about-us/about-us-section-1.png" />
                ...
                <div className="-mb-20 2xl:-mb-96 xl:-mb-80 lg:-mb-72 md:-mb-40">
                ...
                <div className="bg-[#5D64AB] flex flex-col lg:flex-row xl:px-20 lg:px-10 lg:pb-20">
                    <div className="flex-initial mb-4 xl:mb-0 self-center">
                        <img src="/assets/images/about-us/our-story-section.png" className="grow w-full lg:w-screen" />
                    </div>
                <div className="flex-initial px-10 pb-20 lg:pb-0 xl:pl-20 self-center">
                    <h3 className="text-white font-medium text-center lg:text-left text-5xl font-semibold mb-5">Our Story</h3>
                    <p className="text-white text-justify text-xl lg:text-base">
...
function renderIconSection(imageSrc, title, description) {
    return (
        <div className="flex flex-col items-center px-5 lg:px-10 lg:mb-10">
            ...
            <p className="text-[#5D64AB] text-justify">{description}</p>
        </div>
    );
}
